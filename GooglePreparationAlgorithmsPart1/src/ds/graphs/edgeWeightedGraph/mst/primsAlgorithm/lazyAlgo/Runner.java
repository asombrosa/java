...
import ds.graphs.edgeWeightedGraph.mst.primsAlgorithm.lazyAlgo.PrimsLazyAlgorithm;
...
public class Runner {
    public static void main(String[] args) {
        ...
        //edgeWeightedGraph.print();
        MST mst = new PrimsLazyAlgorithm(edgeWeightedGraph);
